  ...
  render() {
    ...
    return (
      <Layout className="containAll">
        ...
        >
          {/*头部github信息  暂无上传github*/}
          {theme === 'light' ? <a href="" target='_blank' rel='noopener noreferrer'><Icon type="github" className="github" /></a> :
            <a href="" target='_blank' rel='noopener noreferrer'><Icon type="github" className="github white" /></a>}
          {theme === 'light' ? <span className="author">王  爽</span> : <span className="author white">王  爽</span>}
          <Menu
            theme={theme}
